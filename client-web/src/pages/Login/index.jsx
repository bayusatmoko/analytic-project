  ...
  return (
    <>
      <div className="bg-gray-200 flex flex-col font-chivo items-center justify-start mx-auto p-20 md:px-10 sm:px-5 w-full">
        <div className="bg-white-A700 flex md:flex-col flex-row gap-12 items-start justify-center max-w-[1112px] mx-auto pl-2 md:px-5 rounded-bl-md rounded-tr-md rounded-br-md rounded-tl-md shadow-bs1 w-full">
